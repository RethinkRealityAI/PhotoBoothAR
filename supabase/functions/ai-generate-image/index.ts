...
/* Frame archetypes, art direction and lettering live in ./frameLayout.ts — a
 * pure, Deno-free sibling that src/lib/assetPrompt.drift.test.ts diffs against
 * the client twin (src/lib/assetPrompt.ts). Deployed with this file. */
